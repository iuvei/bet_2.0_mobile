    ...
    export default {
        ...
        methods:{
          ...
          * */
          ...
          get_last_code: function () {
            this.$http.get(this.api + '/cake/lastLty', {}).then(function (res) {
              //获取到最新一期的数据
              // console.log(res);
              let data = res.data;
          ...
          get_users_handicaps: function () {
            this.$http.get(this.api+'/cake/pans')
              .then(function (res) {
                this.handicaps = [];
          ...
          get_odds: function (which_handicap = null)
          {
            ...
            {
              this.$http.get(`${this.api}/cake/odds?pan=${which_handicap?which_handicap:this.which_handicap}`).then(function (response)
              {
          ...
          do_bet(){
            ...
            this.$http.post(this.api+'/cake/order',{bets:this.all,odds_table:this.which_handicap}).then(function(res){
              // console.log(res);
              if(res.status == 200){
                //清除下注内容
                this.clear_bet();
      ...
      watch:{
        ...
        'which_handicap':function(n,o){
          this.get_odds(n);
          for(var i = 0;i<this.handicaps.length;i++){
